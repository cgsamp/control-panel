...
CGSAMP: Altered I2C device import
"""
...
_HT16K33_DISPLAY_OFF = const(0x80)
_HT16K33_DISPLAY_ON = const(0x81)
...
class HT16K33:
    ...
    def on(self, on):
        self._on = on
        if on:
            self._write_cmd(_HT16K33_DISPLAY_ON)
        else:
            self._write_cmd(_HT16K33_DISPLAY_OFF)
